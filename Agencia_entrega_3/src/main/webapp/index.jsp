            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                ...
                <div class="carousel-caption d-none d-md-block">
                  ...
                  <p>Não há número mínimo de participantes.</p>
                </div>
              </div>
              <div class="carousel-item">
                ...
                <div class="carousel-caption d-none d-md-block">
                  ...
                  <p>Não há preocupações quanto a equipe de apoio, resolvemos isso pra você!</p>
                </div>
              </div>
              <div class="carousel-item">
                ...
                <div class="carousel-caption d-none d-md-block">
                  ...
                  <p>Parcele em até 12x no cartão ou no boleto.</p>
                </div>
              </div>
                ...
                <div class="col"> <!-- coluna 3-->
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Região serrana, é cercada de muitas áreas verdes e altas montanhas.</p>
                            <a href="agendamento.jsp" class="btn btn-primary backcolor3">Quero agendar!</a>
                        </div>
                    </div>
                </div>
